  ...
  return (
    <Main className="justify-start md:justify-center cursor-pencil dark:cursor-pencil-dark">
      <NextHead>
        <meta
          name="keywords"
          content="Rian firnanda, rian, rian firnanda irsyadani"
        />
      </NextHead>
      <Canvas
        ref={canvasRef}
      ...
      <div className="w-full flex flex-col-reverse md:flex-row justify-end md:justify-between items-center">
        <div className="flex flex-col items-center md:items-start space-y-4 justify-center">
          ...
          <p className="noselect text-md md:text-lg text-center md:text-left max-w-[550px]">
           Hai, Saya Rian Firnanda Irsyadani, Seorang pengembang perangkat lunak  yang terutama berfokus pada teknologi web. 
            Saya suka menjelajahi hal-hal terkait teknologi dan sekarang jatuh cinta dengan Kecerdasan buatan dengan bahasa pemrograman Python.
          </p>
